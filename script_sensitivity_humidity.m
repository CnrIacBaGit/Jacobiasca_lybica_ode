function script_sensitivity_humidity(csvPath, matPath)
% SCRIPT_SENSITIVITY_HUMIDITY  sensitivity to the mean relative humidity (\\bar{H}).
%
...
fprintf('[humidity] peak sE = %.4g | sN = %.4g | sA = %.4g\n', ...
