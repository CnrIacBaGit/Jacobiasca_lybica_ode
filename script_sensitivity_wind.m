function script_sensitivity_wind(csvPath, matPath)
% SCRIPT_SENSITIVITY_WIND  sensitivity to the mean wind speed (\\bar{W}).
%
...
fprintf('[wind] peak sE = %.4g | sN = %.4g | sA = %.4g\n', ...
