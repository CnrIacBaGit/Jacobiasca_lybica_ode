function script_sensitivity_radiation(csvPath, matPath)
% SCRIPT_SENSITIVITY_RADIATION  sensitivity to the mean solar radiation (\\bar{R}).
%
...
fprintf('[radiation] peak sE = %.4g | sN = %.4g | sA = %.4g\n', ...
